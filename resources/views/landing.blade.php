            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="land-featurearea">
                    <div class="land-meta">
                        ...
                        <p style="color: black">Made by Phuoc Trung & Minh Hieu with &#10084;&#65039;</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="log-reg-area sign">
                        ...
                        <form method="post">
                            <div class="form-group">
                                ...
                                <label class="control-label" for="input">Email hoặc Tên đăng nhập</label><i class="mtrl-select"></i>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" class="showPassword"/><i class="check-box"></i>Hiện mật khẩu
                                </label>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" checked="checked"/><i class="check-box"></i>Nhớ mật khẩu
                                </label>
                            </div>
                            <a href="#" title="" class="forgot-pwd" style="color: #5271ff">Quên mật khẩu?</a>
                            <div class="submit-btns">
                                <button class="mtr-btn signin" type="button" style="color: #5271ff; width: 194px"><span>ĐĂNG NHẬP</span></button>
